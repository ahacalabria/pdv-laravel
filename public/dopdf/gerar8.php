<?php
require("config.php");
$sql = 'SELECT p.*, e.uf, c.nome as cidade_nome FROM pessoa as p INNER JOIN estados as e INNER JOIN cidades as c ON p.cidade_id = c.id AND e.id = p.estado_id WHERE tipo_cadastro = "fornecedor" AND p.deleted_at is NULL';
...
$pdf->Cell(0,5,utf8_decode("Relatório Geral de Fornecedores"),0,1,'C');
$pdf->Cell(10,35,$result->num_rows." fornecedores listados",0,1,'L');
$pdf->Cell(0,5,"","B",1,'C');
$pdf->Ln(50);
