                ...
                <div class="panel-body">
                  {{ Form::model($user, array('route' => array('users.update', $user->id), 'class' => 'form-horizontal' , 'method' => 'PUT')) }}
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-6">
                            <input disabled="disabled" class="form-control" type="text" value="{{$user->level}}">
                        </div>
                        </div>
                        ...
                        <div class="form-group{{ $errors->has('limite_porcetagem') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                  ...
                                  <input disabled="disabled" name="limite_porcetagem" type="text" class="form-control" aria-label="Valor máximo para desconto em %" value="{{$user->limite_porcetagem}}">
                                </div>
                        ...
                        <div class="form-group{{ $errors->has('limite_dinheiro') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                  ...
                                  <input name="limite_dinheiro" disabled="disabled" type="text" class="form-control" aria-label="Valor máximo para desconto em %" value="{{$user->limite_dinheiro}}">
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                <a class="btn btn-default" href="{{url('users')}}">Voltar</a>
                            </div>
                        </div>
                    {!! Form::close() !!}
                </div>
