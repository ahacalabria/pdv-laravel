<html><head>
  ...
  <tr>
    <td class="desc">Listagem Funcionários - Geral / Detalhada</td>
...
<table class="tg">
  <tr>
    <th class="tg-9hbo"><b>Funcionário:</b> {{ $cliente->nome }} {{ $cliente->sobrenome }}</th>
...
@elseif($contador%5 == 1 && count($data) <= 5)
</div>
</div>
<div class="footers">
    Página <span class="pagenum"></span>
