...
<div class="page-header">
  <h1>Relatório <small>Cliente</small><button id="filtros_show" type="button" class="btn btn-default pull-right" style="display: none"><span class="glyphicon glyphicon-filter"></span> Voltar para os filtros</button></h1>
</div>
@if($errors->has())
...
<div id="filtros" class="row col-sm-12">
  ...
  <div class="form-group col-sm-12">
    <button type="button" url="../../dopdf/gerar3.php" class="btn btn-primary pull-right gerarpdfrh"><span class="glyphicon glyphicon-file"></span> GERAR PDF</button>
  </div>
</form>
<hr>
</div>
